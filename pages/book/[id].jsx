  ...
  async function addToFavorites() {
    try {
      ...
      if (res.status === 200) {
        ...
        console.error("Failed to add book to favorites:", message);
      }
    } catch (err) {
      console.error("Error occurred while adding to favorites:", err);
    }
  }
  async function removeFromFavorites() {
    try {
      ...
      if (res.status === 200) {
        ...
        const { error: message } = await res.json();
        console.error("Failed to remove book from favorites:", message);
      }
    } catch (err) {
